    ...
    <View style={{ flex: 1 }}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={{ flexDirection: 'row', paddingHorizontal: 10 }}>
          ...
          <TouchableOpacity style={styles.addToCartButton} onPress={() => navigation.navigate("Payment")}>
            ...
            <View style={{ flex: 1, flexDirection: 'row', paddingTop: 10 }}>
              {moreProducts.map((item) => (
                <View style={{ width: 180, marginHorizontal: 10 }}>
                  ...
                  <TouchableOpacity style={styles.moreProductBuyButton} onPress={() => navigation.navigate("Payment")}>
